...
import { Check, MapPin, PlusCircle, UploadCloud, X } from "lucide-react";
        ...
        <div className="rounded-xl p-5 flex flex-col gap-4" style={{ background: "var(--bg-secondary, #132333)", border: "1px solid rgba(255,255,255,0.07)" }}>
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label style={{ ...labelStyle, marginBottom: 0 }}>Depot Location (optional)</label>
              <button
                type="button"
            ...
            <p className="text-[10px] mt-1.5" style={{ color: "#8ca5bc" }}>
              Leave blank to use your provider's default location. Set this if this depot is in a different spot.
            </p>
          </div>
