...
export function TopBar({
  ...
  return (
    <nav className="fixed right-0 z-20 flex items-center justify-between h-[60px] px-4 md:px-6"
      style={{
      ...
      <div className="flex items-center gap-2">
        <div className="relative" ref={notificationRef}>
          <button
            ...
            style={{ background: "var(--bg-muted, rgba(255,255,255,0.05))", border: "1px solid var(--border-color, rgba(255,255,255,0.1))", color: "var(--text-secondary, #8ca5bc)" }}>
            <Bell size={16} />
          ...
          <NotificationDropdown
            ...
            onNavigateToAll={() => onNavigate("notifications")}
            color={color}
          />
        </div>
